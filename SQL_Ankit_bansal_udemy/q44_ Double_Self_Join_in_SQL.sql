...
/*
Write a sql query to list emp name along with their manager and senior manager name 
...
select e1.emp_id, e1.emp_name, e2.emp_name as manager_name, e3.emp_name as senior_manager
from emp as e1
